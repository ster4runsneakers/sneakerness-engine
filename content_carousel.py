...
def generate_content_carousel(
    ...
    *,
    ...
    sys_instruction = (
        ...
        "text as small discreet bottom-right watermark — no giant headline, no Explore CTA on image. "
